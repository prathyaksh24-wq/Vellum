...
Embedded Chroma should be opened through one process-wide client for a path.
The watcher and chat path share this singleton instead of racing separate
clients against the same storage directory."""
