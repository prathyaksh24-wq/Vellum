        ...
        features={
            ...
            "discord": FeatureContract(
                ...
                endpoints={
                    ...
                    "archive_status": "/api/plugins/discord/archive/status",
                    "archive_history": "/api/plugins/discord/archive/history",
                    "archive_import": "/api/plugins/discord/archive/import",
                    "send_message": "/api/plugins/discord/channels/{channel_id}/messages",
                    "reply_message": "/api/plugins/discord/channels/{channel_id}/messages/{message_id}/reply",
                    "edit_own_message": "/api/plugins/discord/channels/{channel_id}/messages/{message_id}",
                    "delete_own_message": "/api/plugins/discord/channels/{channel_id}/messages/{message_id}/delete",
                    "add_reaction": "/api/plugins/discord/channels/{channel_id}/messages/{message_id}/reactions",
                    "create_thread": "/api/plugins/discord/channels/{channel_id}/messages/{message_id}/threads",
                    "send_thread_message": "/api/plugins/discord/channels/{channel_id}/threads/{thread_id}/messages",
                    "send_attachment": "/api/plugins/discord/channels/{channel_id}/attachments",
                },
