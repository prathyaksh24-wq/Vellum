...
- Desktop mode no longer launches or closes installed apps, opens visible terminals, or switches OS/browser tabs through legacy desktop compatibility actions. Use workspace/browser tools where possible, or ask the user to open/focus the required app before using native desktop observation and input actions.
