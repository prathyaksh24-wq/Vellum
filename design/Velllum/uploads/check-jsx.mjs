// Validates the embedded React/JSX in vellum-workspace.html compiles.
// Extracts the <script type="text/babel"> block and runs esbuild's JSX transform.
// Usage: node check-jsx.mjs
